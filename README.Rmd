...
Then you could find 10 mzML files in case sub folder and another 10 mzML files in control sub folder, as well as corresponding `test.csv` files with m/z, retention time and compound name of the peaks. 
...
Two shiny apps are provided within the package for raw data/peaks list simulation.
